...
function promptForChange(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // message.
        const fromConventionalCommits = (options.useConventionalCommits &&
            recentMessages.map(conventionalCommits_1.parseConventionalCommit).filter((obj) => !!obj)) ||
            [];
        for (let pkg of changedPackages) {
            ...
            const allowedConventionalCommit = fromConventionalCommits.find((c) => { var _a; return !((_a = disallowedChangeTypes) === null || _a === void 0 ? void 0 : _a.includes(c.type)); });
            ...
            let response = {
                type: options.type || ((_d = allowedConventionalCommit) === null || _d === void 0 ? void 0 : _d.type) || 'none',
                comment: options.message || ((_e = allowedConventionalCommit) === null || _e === void 0 ? void 0 : _e.message) || '',
            };
