...
function promptForChange(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // message.
        const fromConventionalCommits = (usesContentionalCommits &&
            recentMessages
                .map(m => conventionalCommits_1.parseConventionalCommit(m, conventionalOptions))
                .filter((obj) => !!obj)) ||
            [];
        for (let pkg of changedPackages) {
            ...
            const allowedConventionalCommit = fromConventionalCommits.find((c) => { var _a; return c.type && !((_a = disallowedChangeTypes) === null || _a === void 0 ? void 0 : _a.includes(c.type)); });
            ...
            let response = {
                type: options.type || ((_d = allowedConventionalCommit) === null || _d === void 0 ? void 0 : _d.type) || defaults.type,
                comment: options.message || ((_e = allowedConventionalCommit) === null || _e === void 0 ? void 0 : _e.comment) || defaults.comment,
                annotations: (_g = (_f = allowedConventionalCommit) === null || _f === void 0 ? void 0 : _f.annotations, (_g !== null && _g !== void 0 ? _g : defaults.annotations))
            };
            if (questions.length > 0) {
                ...
                if (!response.type || !isValidChangeType_1.isValidChangeType(response.type)) {
                    console.error('Prompt response contains invalid change type.');
                    return;
                }
            }
            packageChangeInfo[pkg] = Object.assign(Object.assign(Object.assign({}, defaults), response), { packageName: pkg, email: workspace_tools_1.getUserEmail(cwd) || 'email not defined', dependentChangeType: options.dependentChangeType || (response.type === 'none' ? 'none' : 'patch') });
        }
